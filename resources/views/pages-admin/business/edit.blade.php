    ...
    <div class="row">
            ...
            <div class="form-group">
              ...
              <select class="form-control form-control-border border-width-2" name="id_local_potential" id="id_local_potential" required>
                  ...
                  @foreach($localPotentials as $localPotential)
                      <option value="{{ $localPotential->id }}" {{ @$selected->id_local_potential == $localPotential->id ? 'selected' : '' }}>
                          {{ $localPotential->name }}
                      </option>
                  @endforeach
              </select>
              ...
              <div class="form-group">
                ...
                <input type="text" name="nib" value="{{@$selected->nib}}" class="form-control form-control-border border-width-2" required>
              </div>
              ...
              <div class="form-group">
                <label>Alamat</label>
                <input type="text" name="address" value="{{@$selected->address}}" class="form-control form-control-border border-width-2">
              </div>
      ...
      <div class="col-md-6">
        <div class="card card-primary">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="date" name="date_of_establishment" value="{{@$selected->date_of_establishment}}" class="form-control form-control-border border-width-2">
            </div>

            <!-- Modal Awal -->
            <div class="form-group">
              <label>Modal Awal</label>
              <input type="text" name="initial_business_capital" value="{{@$selected->initial_business_capital}}" class="form-control form-control-border border-width-2">
            </div>

            <!-- Pendapatan -->
            <div class="form-group">
              <label>Pendapatan</label>
              <input type="text" name="revenue" value="{{@$selected->revenue}}" class="form-control form-control-border border-width-2">
            </div>

            <!-- Digitalisasi -->
            <div class="form-group">
              <label>Digitalisasi</label>
              <input type="text" name="digitalization" value="{{@$selected->digitalization}}" class="form-control form-control-border border-width-2">
            </div>

            <!-- Jumlah Karyawan -->
            <div class="form-group">
              <label>Jumlah Karyawan</label>
              <input type="text" name="employees_count" value="{{@$selected->employees_count}}" class="form-control form-control-border border-width-2">
            </div>

            <!-- Masalah Pengembangan -->
            <div class="form-group">
              <label>Masalah Pengembangan</label>
              <input type="text" name="development_problems" value="{{@$selected->development_problems}}" class="form-control form-control-border border-width-2">
            </div>

            <!-- Kebutuhan Pelatihan -->
            <div class="form-group">
              <label>Kebutuhan Pelatihan</label>
              <input type="text" name="training_needs" value="{{@$selected->training_needs}}" class="form-control form-control-border border-width-2">
            </div>
        <!-- Transaksi Penjualan -->
        <div class="form-group">
        <label>Transaksi Penjualan</label>
        <select name="is_sales_transaction" class="form-control form-control-border border-width-2">
            <option value="0" {{ @$selected->is_sales_transaction == 0 ? 'selected' : '' }}>Tidak</option>
            <option value="1" {{ @$selected->is_sales_transaction == 1 ? 'selected' : '' }}>Ya</option>
        </select>
        </div>
        ...
        <select name="is_access_to_funding" class="form-control form-control-border border-width-2">
            <option value="0" {{ @$selected->is_access_to_funding == 0 ? 'selected' : '' }}>Tidak</option>
            <option value="1" {{ @$selected->is_access_to_funding == 1 ? 'selected' : '' }}>Ya</option>
        </select>
        </div>
        ...
        <select name="is_financial_report" class="form-control form-control-border border-width-2">
            <option value="0" {{ @$selected->is_financial_report == 0 ? 'selected' : '' }}>Tidak</option>
            <option value="1" {{ @$selected->is_financial_report == 1 ? 'selected' : '' }}>Ya</option>
        </select>
        </div>
        ...
        <select name="is_business_account" class="form-control form-control-border border-width-2">
            <option value="0" {{ @$selected->is_business_account == 0 ? 'selected' : '' }}>Tidak</option>
            <option value="1" {{ @$selected->is_business_account == 1 ? 'selected' : '' }}>Ya</option>
        </select>
        </div>
...
<script src="{{ asset('assets/js/admin/business_cu.js').'?v='.date('YmdH') }}?ver=23051701"></script>
@endsection
