<section>
    ...
    <form method="post" action="{{ route('password.update',$user->id) }}" class="mt-6 space-y-6">
        ...
        <div>
            <x-input-label for="password_up" :value="__('Password Baru')" />
            <x-text-input id="password_up" name="password" type="password" class="mt-1 block w-full" autocomplete="new-password" />
